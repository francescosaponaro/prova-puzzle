...
const Settings = ({ redraw, solve, toggleImage, hasImage }) => {
  ...
  return (
    <div className={styles.settings}>
      ...
      />
      <div
        className={clsx(styles.modal, { [styles.open]: showModal })}
        ref={modalRef}
      >
        <div onClick={toggleImage}>
          <PreviewIcon /> {hasImage ? "Nascondi" : "Mostra"} immagine
        </div>
        <div onClick={solve} className={styles.solve}>
          <SolveIcon /> Risolvi
        </div>
        <div onClick={redraw}>
          <RestartIcon /> Ricomincia
        </div>
